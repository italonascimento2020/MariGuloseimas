...
{
    public partial class TelaCadastroVendas : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            sqlDataAdapter.Fill(dataset, "Vendas");
            GridView1.DataSource = dataset;
            GridView1.DataBind();
        }
        protected void Button1_Click(object sender, EventArgs e)
        {
            Response.Redirect("TelaNovaVenda.aspx");
        }
        protected void Delete(int Cod_Venda)
        {
            SqlConnection sqlConnection = new SqlConnection(strConexao);
            sqlConnection.Open();
            SqlCommand sqlCommand = new SqlCommand("delete from [MariGuloseimas].[dbo].[Vendas] where Cod_Venda =" + Cod_Venda, sqlConnection);
            sqlCommand.ExecuteNonQuery();
            this.Page_Load(null, null);
        }
        protected void Delete(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Deltar")
            {
